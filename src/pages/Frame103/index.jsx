        ...
        <div className="flex flex-col gap-[45px] justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1025px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[77%]">
              ...
              <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between md:ml-[0] ml-[3px] mt-[15px] w-[100%]">
                <div className="flex md:flex-1 sm:flex-col flex-row gap-[34px] items-start justify-between md:w-[100%] w-[70%]">
                  <Img
                ...
                <div className="flex md:flex-1 flex-col justify-start md:mt-[0] mt-[3px] md:w-[100%] w-[14%]">
                  <Img
                    src="images/img_overflowmenu.svg"
                    className="h-[24px] md:ml-[0] ml-[81px] w-[24px]"
                    alt="overflowmenu"
                  />
                  <div className="bg-white_A700_bf border-[1px] border-solid border-white_A700_33 flex flex-col gap-[10px] items-start justify-start mr-[7px] p-[10px] rounded-[8px] w-[98px]">
                    <div className="flex items-start justify-start p-[2px] w-[79px]">
                      <Text
                        className="font-black text-left text-purple_900 w-[auto]"
                        variant="body3"
                      >
                        Kinshasa
                      </Text>
                    </div>
                    <div className="flex items-start justify-start p-[2px] w-[74px]">
                      <Text
                        className="font-black text-left text-purple_900 w-[auto]"
                        variant="body3"
                      >
              ...
              <List
                className="flex-col gap-[18px] grid items-center md:ml-[0] ml-[33px] mt-[18px] w-[94%]"
