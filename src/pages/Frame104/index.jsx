        ...
        <div className="flex flex-col justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1022px] mt-[4px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex md:flex-1 flex-col font-inter items-start justify-start md:w-[100%] w-[77%]">
              ...
              <div className="flex flex-row gap-[12px] items-start justify-start md:ml-[0] ml-[3px] mt-[39px] md:w-[100%] w-[27%]">
                <Input
              ...
              <div className="h-[208px] md:h-[212px] md:ml-[0] ml-[3px] mt-[4px] relative w-[26%]">
                <div className="absolute border-[1px] border-solid border-white_A700_33 flex flex-col gap-[10px] h-[100%] inset-y-[0] items-center justify-start left-[0] my-[auto] p-[10px] rounded-[5px] w-[auto]">
                ...
                <div className="absolute bg-black_900 border-[1px] border-solid border-white_A700_33 flex flex-col font-lato gap-[10px] items-center justify-start p-[10px] right-[0] rounded-[8px] top-[0] w-[auto]">
                  <div className="flex items-start justify-start p-[2px] w-[48px]">
                    <Text
                      className="font-normal not-italic text-left text-white_A700 w-[auto]"
                      variant="body5"
                    >
