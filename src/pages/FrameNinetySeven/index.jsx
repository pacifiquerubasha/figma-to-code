...
const FrameNinetySevenPage = () => {
  return (
    <>
      <div className="bg-black_900 border-[1px] border-black_900_7f border-solid flex font-lato items-center justify-start mx-[auto] pb-[484px] w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1022px] mt-[4px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[77%]">
              ...
              <div className="flex flex-row gap-[12px] items-start justify-start md:ml-[0] ml-[3px] mt-[39px] md:w-[100%] w-[30%]">
                ...
                ></Input>
                <Text
                  className="bg-purple_600 border-[1px] border-solid border-white_A700_33 font-extrabold justify-center mb-[3px] p-[5px] rounded-[5px] text-left text-white_A700 w-[auto]"
                  variant="body5"
                >
                  Search
                </Text>
              </div>
              <div className="border-[1px] border-solid border-white_A700_33 flex flex-row gap-[10px] items-start justify-between md:ml-[0] ml-[3px] mt-[39px] p-[10px] rounded-[5px] sm:w-[100%] w-[377px]">
...
export default FrameNinetySevenPage;
