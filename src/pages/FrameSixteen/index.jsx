...
const FrameSixteenPage = () => {
  return (
    <>
      <div className="bg-black_900 border-[1px] border-black_900_7f border-solid flex font-lato items-center justify-start mx-[auto] pb-[78px] w-[100%]">
        <div className="flex flex-col justify-start w-[100%]">
          ...
          <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between max-w-[1022px] mt-[4px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start md:w-[100%] w-[77%]">
              <Text
                className="font-inter font-normal md:ml-[0] ml-[3px] not-italic text-gray_50 text-left w-[auto]"
                as="h1"
                variant="h1"
              >
              ...
              <div className="flex flex-row font-inter gap-[12px] items-center justify-start md:ml-[0] ml-[3px] mt-[39px] md:w-[100%] w-[27%]">
                <Input
              ...
              <Text
                className="font-lato font-normal md:ml-[0] ml-[3px] mt-[22px] not-italic text-left text-white_A700 w-[auto]"
                as="h5"
                variant="h5"
              >
                AFRICA
              ...
              <List
                className="flex-col font-lato gap-[10px] grid items-start max-w-[767px] md:ml-[0] ml-[3px] mt-[21px] w-[100%]"
                orientation="vertical"
              >
                <div className="bg-purple_900 border-[1px] border-solid border-white_A700_33 flex flex-1 flex-row gap-[10px] items-start justify-between max-w-[734px] p-[10px] rounded-[5px] w-[100%]">
                ...
                <div className="border-[1px] border-solid border-white_A700_33 flex flex-1 flex-row gap-[10px] items-start justify-between max-w-[734px] p-[10px] rounded-[5px] w-[100%]">
                  <div className="flex items-start justify-start w-[auto]">
                    <Text
                      className="font-normal not-italic text-left text-white_A700 w-[auto]"
                      variant="body1"
